...
async def cleanup_resources(is_shutting_down=False):
    ...
    Args:
        is_shutting_down (bool): 프로그램이 종료되는 중인지 여부
    """
    ...
    try:
        ...
        print(f"리소스 정리 중 예상치 못한 오류 발생: {e}")
...
if __name__ == "__main__":
    ...
    try:
        # 시작 시에는 GUI 리소스 정리 없이 실행
        loop.run_until_complete(cleanup_resources(is_shutting_down=False))
