...
class ExitGameHandler:
    def __init__(self, image_matcher, capture, MAX_DETECTION_ATTEMPTS=5):
    ...
    def _handle_screen_detection(self, screen, screen_state, screen_type, required_previous_state, loaded_templates):
